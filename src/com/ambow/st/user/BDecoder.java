...
public class BDecoder {
	...
	private long getNumberFromStream(InputStream bais, char parseChar)
			throws IOException {
	...
	private long getNumberFromStreamOld(InputStream bais, char parseChar)
			throws IOException {
		int length = 0;
		// place a mark
		bais.mark(Integer.MAX_VALUE);
	...
	private void print(PrintWriter writer, Object obj, String indent,
			boolean skip_indent) {
	...
	private static void print(File f, File output) {
		try {
			...
			decoder.print(pw, decoder.decodeStream(new BufferedInputStream(
	...
	public static void main(String[] args) {
		print(new File(
				"D:/【上】[1993金超群何家劲版][包青天全集BT种子][41单元263集全DVD-RMVB比特鱼BitFish8.Com].torrent"),
				new File("D:/【上】[1993金超群何家劲版][包青天全集BT种子][41单元263集全DVD-RMVB比特鱼BitFish8.Com].txt"));
	}
}